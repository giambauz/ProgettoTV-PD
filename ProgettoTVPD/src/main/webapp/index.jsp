...
<body
	style="background: radial-gradient(50% 50% at 50% 50%, #41908F 0%, #0C6677 100%) !important;">

	<img class="wallpaper_gen img-responsive" alt="wallpaper-login"
		src="img/wallpaper_index.png">

	<div class="container_login">
		<div class="body_login">

			<h1 class="titolo_login">
				<strong> <%
 ...
 %>
			...
			<h1 class="sottotitolo_login">Benvenuto nella nostra area di
				accesso per gli amministratori</h1>

			<form class="form_login form-horizontal"
					...
					<div class="inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								name="nomeAdmin" id="nomeAdmin" placeholder="Nome..."
				...
				<div class="form-group">
					<div class="inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-user"></i></span> <input type="text"
								name="cognomeAdmin" id="cognomeAdmin" placeholder="Cognome..."
								class="form-control" required>
						</div>
					</div>
				</div>
					...
					<div class="inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								name="codAdmin" id="codAdmin" placeholder="Codice di accesso..."
								class="form-control" required> <span
								onclick="showHideLoginAmministratore()"
								class="input-group-addon"> <i id="cod-icon"
				...
				<div class="form-group login-ricordami-lt" style="display: flex;">
				...
				<%
				if ((Integer) session.getAttribute("countTentativi") > 0 && (Integer) session.getAttribute("countTentativi") != 5) {
				%>
				<p class="tentativi_login">
					Tentativi rimasti:&nbsp;<strong><%=session.getAttribute("countTentativi")%></strong>
				</p>
				<%
				}
				%>
		...
		<div class="footer_login">
			<p>&copy;&nbsp;Copyright - Gestione corsi betacom Treviso-Padova
			<p>
		</div>
